...
# Unit tests for Harbor2LegacyClient::ProjectMember
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProjectMember' do
  before do
    # run before each test
    @instance = Harbor2LegacyClient::ProjectMember.new
  end
  ...
  describe 'test an instance of ProjectMember' do
    it 'should create an instance of ProjectMember' do
      expect(@instance).to be_instance_of(Harbor2LegacyClient::ProjectMember)
    end
  end
