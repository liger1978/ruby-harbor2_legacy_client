...
# Unit tests for Harbor2LegacyClient::ChartVersion
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChartVersion' do
  before do
    # run before each test
    @instance = Harbor2LegacyClient::ChartVersion.new
  end
  ...
  describe 'test an instance of ChartVersion' do
    it 'should create an instance of ChartVersion' do
      expect(@instance).to be_instance_of(Harbor2LegacyClient::ChartVersion)
    end
  end
