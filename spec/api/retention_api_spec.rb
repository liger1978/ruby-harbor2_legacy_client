...
# Unit tests for Harbor2LegacyClient::RetentionApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RetentionApi' do
  before do
    # run before each test
    @instance = Harbor2LegacyClient::RetentionApi.new
  end
  ...
  describe 'test an instance of RetentionApi' do
    it 'should create an instance of RetentionApi' do
      expect(@instance).to be_instance_of(Harbor2LegacyClient::RetentionApi)
    end
  end
