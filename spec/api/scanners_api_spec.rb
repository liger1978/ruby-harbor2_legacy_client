...
# Unit tests for Harbor2LegacyClient::ScannersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScannersApi' do
  before do
    # run before each test
    @instance = Harbor2LegacyClient::ScannersApi.new
  end
  ...
  describe 'test an instance of ScannersApi' do
    it 'should create an instance of ScannersApi' do
      expect(@instance).to be_instance_of(Harbor2LegacyClient::ScannersApi)
    end
  end
